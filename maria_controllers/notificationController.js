...
const { notificationsSchemaModel } = require('../maria_models/notificationsModel');


module.exports = {
    getNotifications: async (req, res) => {
        const notifications = await notificationsSchemaModel.findAll({
          where : { notif_to_user: req.body.user_id },
          order : [
              ['created', 'DESC'],
          ]});

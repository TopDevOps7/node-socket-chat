...
module.exports = {
    ...
    setTopMessage: async (req, res, next) => {
        ...
        try {
            ...
            const newTopMsg = await PublicRoomMessageSchemaModel.findOneAndUpdate({message_id: msgId}, {
                top: true,
    ...
    cancelTopMessage: async (req, res, next) => {
        const {msgId, userId} = req.params;
        try {
            const msg = await PublicRoomMessageSchemaModel.findOneAndUpdate({message_id: msgId}, {
                top: false,
                top_set_user_id: userId,
                top_set_time: Date.now()
            });
    ...
    sendAnnouncement: async (req, res, next) => {
     ...
     deleteMessage: async (req, res, next) => {
         try {
            ...
            await PublicRoomMessageSchemaModel.findOneAndDelete({message_id: id});

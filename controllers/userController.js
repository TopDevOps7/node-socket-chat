...
//   }     
    ...
    getUserByEmail: async (req, res) => {
        if (req.body.email) {
            ...
            if (!user) {
                res.status(404).json({ error: true, data: "getUserByEmail no user found !" });
            } else {
                res.status(200).json({ error: false, data: user });
            }
        } else {
    ...
    getUserByNumber: async (req, res) => {
        if (req.body.number) {
            ...
            if (!user) {
                res.status(404).json({ error: true, data: "getUserByNumber no user found !" });
            } else {
                res.status(200).json({ error: false, data: user });
            }
        } else {
    ...
    getUserSettings: async (req, res) => {
        ...
        try {
            ...
            console.error(err)
            res.status(500).json({ error: true, data: "getUserSettings no user found !" });
        }
    },
    setUserSettings: async (req, res) => {
        ...
        try {
            ...
            res.status(500).json({ error: true, data: "setUserSettings no user found !", err: err.message });
        }
    },
    getUserGender: async (req, res) => {
        ...
        try {
            ...
            res.status(500).json({ error: true, data: "getUserGender no user found !" });
        }
    },
    setUserGender: async (req, res) => {
        ...
        try {
            ...
            res.status(500).json({ error: true, data: "setUserGender no user found !" });
        }
    },
    getUserName: async (req, res) => {
        ...
        try {
            ...
            res.status(500).json({ error: true, data: "getUserName no user found !" });
        }
    },
    ...
    getLocation: async (req, res) => {
        ...
        try {
            ...
            res.status(500).json({ error: true, data: "getLocation no user found !" });
        }
    },
    setLocation: async (req, res) => {
        ...
        try {
            ...
            res.status(500).json({ error: true, data: "setLocation no user found !" });
        }
    },
    setLike: async (req, res) => {
        ...
        try {
            ...
            res.status(500).json({ error: true, data: "setLike no user found !" });
        }
    },
    setDislike: async (req, res) => {
        ...
        try {
            ...
            res.status(500).json({ error: true, data: "setDislike no user found !" });
        }
    },
    getUserDetails: async (req, res) => {
        ...
        try {
            ...
            res.status(500).json({ error: true, data: "getUserDetails no user found !" });
        }
    },
};
